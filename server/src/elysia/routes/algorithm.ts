...
const findBestClosed = async (ctx: any) => {
...
const findBestSolution = async (ctx: any) => {
  return Submission.aggregate([
...
const findBestSolved = async (ctx: any) => {
  return Submission.aggregate([
...
const findBestLower = async (ctx: any) => {
  return Submission.aggregate([
...
const findSolvedDomainQuery = async (ctx: any) => {
  return Submission.aggregate([
    { $match: { $expr: { $ne: ["$solution_cost", null] } } },
    {
      $group: {
...
const findClosedDomainQuery = async (ctx: any) => {
  return Submission.aggregate([
    { $match: { $expr: { $eq: ["$lower_cost", "$solution_cost"] } } },
    {
      $group: {
...
const findBestLowerDomainQuery = async (ctx: any) => {
  return Submission.aggregate([
    { $match: { best_lower: true } },
    {
      $group: {
...
const findBestSolutionDomainQuery = async (ctx: any) => {
  return Submission.aggregate([
    { $match: { best_solution: true } },
    {
      $group: {
...
const findBestLowerGroup = async (ctx: any) => {
...
const findBestSolutionGroup = async (ctx: any) => {
  const id = new Types.ObjectId(ctx.params.id);
  const query3 = Algorithm.find({ _id: id });
  const query1 = Submission.aggregate([
    { $match: { best_solution: true } },
...
const findBestClosedGroup = async (ctx: any) => {
  const id = new Types.ObjectId(ctx.params.id);
  const query3 = Algorithm.find({ _id: id });
  const query1 = Submission.aggregate([
    { $match: { $expr: { $eq: ["$lower_cost", "$solution_cost"] } } },
...
const findBestSolvedGroup = async (ctx: any) => {
  const id = new Types.ObjectId(ctx.params.id);
  const query3 = Algorithm.find({ _id: id });
  const query1 = Submission.aggregate([
    { $match: { $expr: { $ne: ["$solution_cost", null] } } },
...
const LeadingSolvedInfo = async (ctx: any) => {
...
const LeadingLowerInfo = async (ctx: any) => {
  return Algorithm.aggregate([
    {
      $lookup: {
        from: "submissions",
...
const findScenBestClosed = async (ctx: any) => {
...
const findScenBestSolved = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findScenBestLower = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findScenBestSolution = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findAgentBestClosed = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findAgentBestSolved = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findAgentBestLower = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findAgentBestSolution = async (ctx: any) => {
  const map_id = new Types.ObjectId(ctx.params.id);
  return Submission.aggregate([
    {
      $match: {
...
const findAgentSolutionCost = async (ctx: any) => {
...
const findAgentLower = async (ctx: any) => {
  const [mapId, scenId] = (ctx.params.pair ?? "").split("&");
  const map_id = new Types.ObjectId(mapId);
  const scen_id = new Types.ObjectId(scenId);
  return Submission.aggregate([
...
export const algorithmRoutes = new Elysia({ prefix: "/api/algorithm" })
  ...
  .get("/getClosedInfo", findBestClosed)
  .get("/getLowerInfo", findBestLower)
  .get("/getSolutionInfo", findBestSolution)
  .get("/getSolvedInfo", findBestSolved)
  .get("/test", findBestLowerDomainQuery)
  .get("/getDomainClosedInfo", findClosedDomainQuery)
  .get("/getDomainSolvedInfo", findSolvedDomainQuery)
  .get("/getDomainLowerInfo", findBestLowerDomainQuery)
  .get("/getDomainSolutionInfo", findBestSolutionDomainQuery)
  .get("/getScenClosedInfo/:id", findScenBestClosed)
  .get("/getScenSolvedInfo/:id", findScenBestSolved)
  .get("/getScenLowerInfo/:id", findScenBestLower)
  .get("/getScenSolutionInfo/:id", findScenBestSolution)
  .get("/getAgentClosedInfo/:id", findAgentBestClosed)
  .get("/getAgentSolvedInfo/:id", findAgentBestSolved)
  .get("/getAgentLowerInfo/:id", findAgentBestLower)
  .get("/getAgentSolutionInfo/:id", findAgentBestSolution)
  .get("/getAgentSolutionCost/:pair", findAgentSolutionCost)
  .get("/getAgentLower/:pair", findAgentLower);
