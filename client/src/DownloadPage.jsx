      ...
      <Paper>
        ...
        >
          <Typography
            ...
            gutterBottom
          >
            This page contains download links to all best-known results, and all
            corresponding benchmark problem instances, currently submitted to
            the MAPF Tracker. Results and benchmarks are offered as separate
            downloads, grouped by map, and in zip format.
          </Typography>
          ...
          <ul>
            <Typography
              ...
              gutterBottom
            >
              To download results, please visit{" "}
              <Link href="http://tracker.pathfinding.ai/quickDownload/results/">
                here
              </Link>
              .
            </Typography>
            <Typography
              ...
              gutterBottom
            >
              To download benchmarks, please visit{" "}
              <Link href="http://tracker.pathfinding.ai/quickDownload/benchmarks/">
                here
              </Link>
              .
            </Typography>
      ...
      <Paper>
        ...
        >
          ...
          <Typography
            ...
            gutterBottom
          >
            Each results archive (zip file) contains a single file, with comma
            separated values, which describes best known results for a single
            grid map. The first line of the file is a header, which gives column
            names. Each subsequent line gives the corresponding values for a
            single problem instance. Where a best-known solution is available,
            we also give the corresponding plan. Further details about the
            solution plan format are available{" "}
            <Link href="http://tracker.pathfinding.ai/contributes">here</Link>.
          </Typography>
          <Typography
            sx={{ fontSize: 16, flex: "1 1 100%" }}
            component="div"
